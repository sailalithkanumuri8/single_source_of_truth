          ...
          <div className="metrics-grid">
            ...
            <div className="metric-card">
              ...
              <div className="metric-info">
                ...
                <span className="metric-value">{escalation.context.timeToSLA}</span>
              </div>
            </div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-info">
                ...
                <span className="metric-value">{escalation.context.customerTier}</span>
              </div>
            </div>
            ...
            <div className="metric-card">
              ...
              <div className="metric-info">
                ...
                <span className="metric-value">{escalation.context.estimatedResolutionTime}</span>
              </div>
            </div>
          </div>
          ...
          <div className="section-card ai-reasoning">
            <div className="section-header">
              ...
              <div>
                ...
                <p className="section-subtitle">Why this escalation was routed to {escalation.assignedTo}</p>
              </div>
            </div>
          ...
          <div className="section-card">
            ...
            <div className="context-grid">
              <div className="context-item">
                ...
                <span className="context-value">{escalation.context.impactLevel}</span>
              </div>
              <div className="context-item">
                <span className="context-label">Business Impact</span>
                <span className="context-value">{escalation.context.businessImpact}</span>
              </div>
              <div className="context-item">
                ...
                <span className={`context-value ${escalation.context.slaStatus === 'At risk' ? 'text-danger' : 'text-success'}`}>
                  {escalation.context.slaStatus}
                </span>
              </div>
              <div className="context-item">
                <span className="context-label">Previous Escalations</span>
                <span className="context-value">{escalation.context.previousEscalations}</span>
              </div>
            </div>
